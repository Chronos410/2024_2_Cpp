...
public:
	...
	{
		currentBullet--;
		cout << "GunLaser Fire 함수 실행 / GUN_UID : " << gun_uid << endl;
	}
	void Aim(int TARGETUID)
	{
		cout << "GunLaser Aim 함수 실행 / TargetPlayer : " << TARGETUID << endl;
	}
	void CheckBullet()
	{
		cout << "잔탄 : " << currentBullet << "/" << maxBullet << endl;
		cout << "GunLaser CheckBullet 함수 실행" << endl;
	}
	void Reload()
	{
		currentBullet = maxBullet;
		cout << "GunLaser Reload 함수 실행" << endl;
	}
	void GunBroke()
	{
		isBroke = true;
		cout << "GunLaser GunBroke 함수 실행" << endl;
	}
};