...
public:
    ...
    void GunCheckBullet()
    {
        cout << "HUMAN GunCheckBullet 함수 실행됨 / HumanUID : " << uid << endl;
        if (isGunBullet)
            gunB->CheckBullet();
        else
            gunL->CheckBullet();
    ...
    void ChangeGunBullet(GunBullet* GUN)
    {
        isGunBullet = true;
        gunB = GUN;
        cout << "HUMAN ChangeGunBullet 함수 실행됨 / HumanUID : " << uid << endl;
    }
    void ChangeGunLaser(GunLaser* GUN)
    {
        isGunBullet = false;
        gunL = GUN;
        cout << "HUMAN ChangeGunLaser 함수 실행됨 / HumanUID : " << uid << endl;
    }
